...
public class Ageratio extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        numberPicker.setOnValueChangedListener(new NumberPicker.OnValueChangeListener() {
            ...
            public void onValueChange(NumberPicker picker, int oldVal, int newVal) {
                ...
                double weight;
                weight = (newVal+9.00)/2;
                weight1.setText(""+
                        weight +"kg.");
                age.setText(""+newVal+"Months");
    ...
    public void calculate(int age) {
        int weight;
        weight = (age + 9) / 2;
        Toast.makeText(getApplicationContext(), weight + " is your child's weight", Toast.LENGTH_SHORT).show();
    ...
    public void onStart() {
        ...
        Action viewAction = Action.newAction(
                ...
                "Ageratio Page", // TODO: Define a title for the content shown.
